...
def get_scatter_chart(entered_site, payload):
                                    ...
                                    print("Payload range:", payload)

                                    range_payload_low = payload[0]
                                    range_payload_high = payload[1]
                                    
                                    filtered_df = spacex_df[
                                    (spacex_df['Payload Mass (kg)'] >= range_payload_low) &
                                    (spacex_df['Payload Mass (kg)'] <= range_payload_high)]
                                    ...
                                    if entered_site == 'ALL':
                                        ...
                                        title='Success Rate over Payload Mass'       
                                        )
                                        return fig
                                    else:
                                        filtered_site_df= filtered_df[filtered_df['Launch Site'] == entered_site]
                                        ...
                                        y = "class",
                                        color = "Booster Version Category",
                                        title=f'Success Rate over Payload Mass for {entered_site}'
                                        )
                                        return fig
